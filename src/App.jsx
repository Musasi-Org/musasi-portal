  ...
  return (
    <div className="bg-game-accent/50 p-6 rounded-lg backdrop-blur-sm">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h4 className="font-game text-sm">{label}</h4>
      </div>
      <p className="font-pixel text-3xl text-game-primary">
        {prefix}{value}
      </p>
    </div>
  );
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-game text-2xl text-game-primary glow">MUSASI</h1>
          </div>
          <nav className="hidden md:flex gap-6 font-pixel text-xl">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            <motion.h2 
              className="font-game text-4xl md:text-6xl mb-6"
            ...
            <p className="font-pixel text-xl mb-8">
              Embark on an epic web3 gaming adventure where strategy meets blockchain technology.
            </p>
            <div className="flex justify-center md:justify-start">
              <motion.button
                onClick={handlePlayClick}
                className="bg-game-primary text-white font-game px-8 py-4 rounded-lg text-lg hover:bg-opacity-90 transition-all transform hover:scale-105"
        ...
        {/* Live Stats Section */}
        <div className="mt-20">
          <h3 className="font-game text-2xl text-center mb-8">Live Statistics</h3>
